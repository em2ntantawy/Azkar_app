...
class morining extends StatefulWidget {
  const morining({Key? key}) : super(key: key);

  @override
  State<morining> createState() => _moriningState();
}

class _moriningState extends State<morining> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(
          future:
              DefaultAssetBundle.of(context).loadString("images/morning.json"),
